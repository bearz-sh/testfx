...
public class BearzTestCaseRunner : XunitTestCaseRunner, IDisposable
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="BearzTestCaseRunner" /> class.
    /// </summary>
            ...
            for (var i = 0; i < parameters.Length; i++)
            {
                ...
                if (obj == null)
                {
                    ...
                    obj = pt.FullName switch
                    {
                        ...
                        "Xunit.Sdk.BearzTestCase" => (BearzTestCase)this.TestCase,
