...
public class BearzTestCase : XunitTestCase
{
    [Obsolete("Called by the de-serializer; should only be called by deriving classes for de-serialization purposes")]
    public BearzTestCase()
        : base()
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="BearzTestCase"/> class.
    /// </summary>
        ...
        CancellationTokenSource cancellationTokenSource)
    {
        ...
        if (BearzTestDiscoverer.ServiceProviderLocator is null)
        {
        ...
        using var runner = new BearzTestCaseRunner(
