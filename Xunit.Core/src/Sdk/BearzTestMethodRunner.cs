...
/// <summary>
/// Bearz test method runner for xunit v2 tests. The test method runner creates
/// the test case runner and invokes it.
/// </summary>
public class BearzTestMethodRunner : TestMethodRunner<IXunitTestCase>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BearzTestMethodRunner"/> class.
    /// </summary>
    ...
    {
        if (testCase is BearzTestCase bearzTestCase)
        {
            return bearzTestCase.RunAsync(
                this.serviceProvider,
                BearzTestDiscoverer.ServiceProviderLocator,
